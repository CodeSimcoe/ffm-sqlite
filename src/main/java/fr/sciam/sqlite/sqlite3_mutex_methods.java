...
public class sqlite3_mutex_methods {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        SQLite3.C_POINTER.withName("xMutexInit"),
        SQLite3.C_POINTER.withName("xMutexEnd"),
        SQLite3.C_POINTER.withName("xMutexAlloc"),
        SQLite3.C_POINTER.withName("xMutexFree"),
        SQLite3.C_POINTER.withName("xMutexEnter"),
        SQLite3.C_POINTER.withName("xMutexTry"),
        SQLite3.C_POINTER.withName("xMutexLeave"),
        SQLite3.C_POINTER.withName("xMutexHeld"),
        SQLite3.C_POINTER.withName("xMutexNotheld")
    ...
    public static class xMutexInit {
        ...
        private static final MethodHandle UP$MH = SQLite3.upcallHandle(xMutexInit.Function.class, "apply", $DESC);
    ...
    public static class xMutexEnd {
        ...
        private static final MethodHandle UP$MH = SQLite3.upcallHandle(xMutexEnd.Function.class, "apply", $DESC);
    ...
    public static class xMutexAlloc {
        ...
        private static final MethodHandle UP$MH = SQLite3.upcallHandle(xMutexAlloc.Function.class, "apply", $DESC);
    ...
    public static class xMutexFree {
        ...
        private static final MethodHandle UP$MH = SQLite3.upcallHandle(xMutexFree.Function.class, "apply", $DESC);
    ...
    public static class xMutexEnter {
        ...
        private static final MethodHandle UP$MH = SQLite3.upcallHandle(xMutexEnter.Function.class, "apply", $DESC);
    ...
    public static class xMutexTry {
        ...
        private static final MethodHandle UP$MH = SQLite3.upcallHandle(xMutexTry.Function.class, "apply", $DESC);
    ...
    public static class xMutexLeave {
        ...
        private static final MethodHandle UP$MH = SQLite3.upcallHandle(xMutexLeave.Function.class, "apply", $DESC);
    ...
    public static class xMutexHeld {
        ...
        private static final MethodHandle UP$MH = SQLite3.upcallHandle(xMutexHeld.Function.class, "apply", $DESC);
    ...
    public static class xMutexNotheld {
        ...
        private static final MethodHandle UP$MH = SQLite3.upcallHandle(xMutexNotheld.Function.class, "apply", $DESC);
