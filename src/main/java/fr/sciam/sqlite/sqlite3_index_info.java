...
public class sqlite3_index_info {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        SQLite3.C_INT.withName("nConstraint"),
        MemoryLayout.paddingLayout(4),
        SQLite3.C_POINTER.withName("aConstraint"),
        SQLite3.C_INT.withName("nOrderBy"),
        MemoryLayout.paddingLayout(4),
        SQLite3.C_POINTER.withName("aOrderBy"),
        SQLite3.C_POINTER.withName("aConstraintUsage"),
        SQLite3.C_INT.withName("idxNum"),
        MemoryLayout.paddingLayout(4),
        SQLite3.C_POINTER.withName("idxStr"),
        SQLite3.C_INT.withName("needToFreeIdxStr"),
        SQLite3.C_INT.withName("orderByConsumed"),
        SQLite3.C_DOUBLE.withName("estimatedCost"),
        SQLite3.C_LONG_LONG.withName("estimatedRows"),
        SQLite3.C_INT.withName("idxFlags"),
        MemoryLayout.paddingLayout(4),
        SQLite3.C_LONG_LONG.withName("colUsed")
    ...
    public static class sqlite3_index_constraint {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            SQLite3.C_INT.withName("iColumn"),
            SQLite3.C_CHAR.withName("op"),
            SQLite3.C_CHAR.withName("usable"),
            MemoryLayout.paddingLayout(2),
            SQLite3.C_INT.withName("iTermOffset")
    ...
    public static class sqlite3_index_constraint_usage {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            SQLite3.C_INT.withName("argvIndex"),
            SQLite3.C_CHAR.withName("omit"),
            MemoryLayout.paddingLayout(3)
